...
export function senDataWon(data){
    let btt = document.querySelector('poke-batallas').renderRoot.querySelector('battle-poke');
    btt.dispatchEvent(new CustomEvent('poke-won', {
        detail:{data},
        bubbles:true,
        composed: true
    }));
...
export function activarBtnBatalla(battle) {
    ...
    let btt = document.querySelector('poke-batallas').renderRoot.querySelector('battle-poke').renderRoot.querySelector('div');;
